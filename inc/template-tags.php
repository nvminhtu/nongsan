...
function sparkling_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			<div class="nav-previous"> <?php next_posts_link( __( '<i class="fa fa-chevron-left"></i> Bài viết cũ', 'sparkling' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Bài viết mới <i class="fa fa-chevron-right"></i>', 'sparkling' ) ); ?> </div>
			<?php endif; ?>
...
function short_content($num_words) {
  global $post;
